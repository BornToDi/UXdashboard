    ...
    <div class="q-pa-md">
      <div class="row q-col-gutter-md">
        <div class="col-12 col-md">
          <q-card class="my-card q-py-sm bg-light-blue-4">
            <q-item>
            ...
            <q-item>
              ...
              <q-item-section>
                <q-btn color="grey" label="Folloaw" />
              </q-item-section>
            </q-item>
          </q-card>
        </div>
        ...
        <div class="col-12 col-md">
          <q-card class="my-card q-py-sm bg-green-13">
            <q-item>
              <q-item-section>
                <q-btn
                  color="light-blue-8"
      ...
      <div class="row q-col-gutter-md">
        <div class="col-12 col-md">
          <q-toolbar>
            <q-toolbar-title class="text-overline"
              >ACTIVE PROJECTS</q-toolbar-title
            >
            <q-btn flat text-color="light-blue-8" label="Show All" />
          </q-toolbar>

          <q-card
            class="my-card bg-light-green-14"
            style="padding: 33px 0px 33px 0px"
          >
            <q-item>
              <q-item-section avatar>
                <q-btn
              ...
              <q-item-section>
                <q-btn color="light-blue-8" label="Deliver" />
                <q-btn
                  text-color="black"
                  label="Cancel"
                  outline
        ...
        <div class="col-12 col-md">
          ...
          <q-card class="my-card q-py-sm bg-deep-orange">
            <q-item>
              <q-item-section avatar>
                <q-btn
                  round
          ...
          <q-card class="my-card q-py-sm q-mt-sm bg-cyan-14 shadow-2">
            <q-item>
              <q-item-section avatar>
                <q-btn
                  round
      ...
      <q-toolbar>
        <q-toolbar-title><strong>My shots</strong></q-toolbar-title>
        <q-btn
          color="dark"
